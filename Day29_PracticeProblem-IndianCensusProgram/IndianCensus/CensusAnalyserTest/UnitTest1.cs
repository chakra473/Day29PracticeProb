...
namespace CensusAnalyserTest
{
    public class Tests
    {
        ...
        static string indianStateCensusFilePath = @"D:\.Net\PracticeProblem\census\IndianCensus\CensusAnalyserTest\CSVFiles\IndiaStateCensusData.csv";
        static string wrongHeaderIndianCensusFilePath = @"D:\.Net\PracticeProblem\census\IndianCensus\CensusAnalyserTest\CSVFiles\WrongIndiaStateCensusData.csv";
        static string delimiterIndianCensusFilePath = @"D:\.Net\PracticeProblem\census\IndianCensus\CensusAnalyserTest\CSVFiles\IndianStateCesusDelimeter.csv";
        static string wrongIndianStateCensusFileType = @"D:\.Net\PracticeProblem\census\IndianCensus\CensusAnalyserTest\CSVFiles\IndianStateCensus.txt";
        static string indianStateCodeFilePath = @"D:\.Net\PracticeProblem\census\IndianCensus\CensusAnalyserTest\CSVFiles\IndiaStateCodes.csv";
        static string wrongIndianStateCodeFileType = @"D:\.Net\PracticeProblem\census\IndianCensus\CensusAnalyserTest\CSVFiles\IndiaStateCodes.txt";
        static string delimiterIndianStateCodeFilePath = @"D:\.Net\PracticeProblem\census\IndianCensus\CensusAnalyserTest\CSVFiles\DelimiterIndiaStateCodes.csv";
        static string wrongHeaderStateCodeFilePath = @"D:\.Net\PracticeProblem\census\IndianCensus\CensusAnalyserTest\CSVFiles\WrongHeaderIndiaStateCodes.csv";
        ...
        {
            var censusException = Assert.Throws<CensusAnalyserException>(() => censusAnalyser.LoadCensusData(CensusAnalyser.Country.INDIA, wrongHeaderStateCodeFilePath, indianStateCensusHeaders));
